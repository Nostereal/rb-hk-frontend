                ...
                <div className={b('header')}>
                    ...
                    >
                        <Paragraph style={{ maxWidth: '90%' }}>
                            {strategy && strategy.type === StrategyType.INSTANT ? INSTANT_STRATEGY_DESCRIPTION : AGGREGATE_STRATEGY_DESCRIPTION}
                        </Paragraph>
                    </PageHeader>
                    {strategy && (strategy.type === StrategyType.INSTANT
                        ? <InstantStrategiesCreateForm mode={Mode.VIEW} strategy={strategy.settings as InstantStrategy}/>
                        : <AggregateStrategiesCreateForm mode={Mode.VIEW} strategy={strategy.settings as AggregateStrategy}/>)}
                </div>
            </div>
        </div>
    )
